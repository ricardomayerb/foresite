...
```{r, echo=FALSE}
error_names <- c("Test data","VAR", "SARIMAX","VAR", "SARIMAX","VAR", "SARIMAX","VAR", "SARIMAX")
knitr::kable(
  data_for_table, booktabs = TRUE, digits = 1, col.names = error_names,
  caption = 'Out-of-sample errors, VAR vs SARIMAX', align = 'c', padding = 2)  
